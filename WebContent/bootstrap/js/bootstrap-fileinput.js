...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        uploadIcon: '<i class="icon-folder-open btn-info"></i>',
    ...
    tIcon = '<span class="icon-file kv-caption-icon"></span>';
    ...
    tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
        '   {uploadIcon}\n</button>\n';
    tZoom = '<button type="button" class="btn btn-danger btn-xs btn-block" title="{zoomTitle}: {caption}" onclick="{dialog}">\n' +
        '   {zoomInd}\n' +
        '</button>\n';
...
//            return fileName ? '<b>' + fileName + ': </b>' + errMsg : errMsg;
        ...
        uploadSingle: function (i, files, allFiles) {
            ...
            fnSuccess = function (data, textStatus, jqXHR) {
            	if(data.errno == 0){
            		document.getElementById("headDiv").innerHTML = '<span id="head_url">'+data.data+'</span>';
            ...
            fnError = function (jqXHR, textStatus, errorThrown) {
            	$.extend(params, self.getOutData(jqXHR));
                var errMsg = self.parseError(jqXHR, errorThrown, (allFiles ? files[i].name : null));
                errMsg = '<span id="head_url">'+errMsg+'</span>';
                setTimeout(function () {
                    if (allFiles) {
                        updateUploadLog(i, previewId);
                    }
    ...
    $.fn.fileinput.defaults = {
        ...
        cancelIcon: '<i class=" icon-remove"></i>',
        cancelClass: 'btn btn-danger',
        uploadIcon: '<i class="icon-arrow-up"></i>',
        uploadClass: 'btn btn-info',
        uploadUrl: '/Art/cmsUploadImg',
        uploadAsync: true,
        uploadExtraData: {},
        minImageWidth: null,
        minImageHeight: null,
